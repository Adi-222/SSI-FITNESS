...
export const TRAINERS = [
  {
    ...
    experience: "12+ Years",
    bio: "Former national boxing champion with a passion for developing fighters. Specializes in technique refinement and competitive preparation.",
    certifications: ["NSCA-CPT", "Boxing Coach Level 3", "MMA Instructor"],
  },
  {
    id: "trainer-2",
    name: "Coach Priya",
  ...
  },
  {
    id: "trainer-4",
    name: "Coach Sneha",
    specialization: "Recovery & Wellness",
    experience: "6+ Years",
    bio: "Certified therapist specializing in sports massage, cupping therapy, and holistic recovery techniques for optimal performance.",
    certifications: ["Licensed Massage Therapist", "Cupping Certified", "Yoga RYT-500"],
  },
];
